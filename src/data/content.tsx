...
import { FaFacebook, FaHeadphones, FaXTwitter } from 'react-icons/fa6';
...
export const socialLinks = [
  { href: '#fb', Icon: <FaFacebook className="h-full w-full" /> },
  { href: '#x', Icon: <FaXTwitter className="h-full w-full" /> },
  { href: '#pin', Icon: <FaPinterest className="h-full w-full" /> },
  { href: '#ai', Icon: <AiOutlineLink className="h-full w-full" /> },
];
...
export const footerData = {
  description: 'HotKicks was designed and founded in 2023 by Person. The theme is about sneakers ecommerce thet use for shoes selling around the world.',
  footerLinks: [
    {
      title: 'Main Pages',
      links: [
  ...
  footerGetToKnowUs: [
    { href: '/about', name: 'About QuickCart' },
    { href: '/contact', name: 'Contact Us' },
  ],

  footerQuickLinks: [
    { href: '/help/termsandCondition', name: 'Terms & Conditions' },
    { href: '/help/privacypolicy', name: 'Privacy Policy' },
    { href: '/help/FAQs', name: 'FAQs' },
  ],
};
